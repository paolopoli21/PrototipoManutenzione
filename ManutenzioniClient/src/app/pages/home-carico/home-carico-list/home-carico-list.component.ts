...
@Component({
  selector: 'app-home-carico-list',
  templateUrl: './home-carico-list.component.html',
  styleUrls: ['./home-carico-list.component.scss'],
  animations: [
...
export class HomeCaricoListComponent implements OnInit ,OnDestroy{
